...
cs({ trig = "sb([%w]+)", regTrig = true, hidden = true },
    fmt([[
import {{ Canvas, Controls, Meta, Story, Primary }} from '@storybook/blocks'

import * as {}Stories from './{}.stories'

# {}

The `{}` is a general purpose button used to login with an OAuth provider and return a session.
